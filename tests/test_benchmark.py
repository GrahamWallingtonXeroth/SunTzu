...
class TestGameTelemetry:
    ...
    def test_write_and_read_jsonl(self):
        gt = GameTelemetry(
            game_id="test2", p1_strategy="x", p2_strategy="y", winner="p1", victory_type="sovereign_capture", turns=10
        )
...
class TestMetrics:
    def test_brier_perfect(self):
        ...
        reports[0].beliefs["f1"] = BeliefState(distribution={1: 0, 2: 0, 3: 1.0, 4: 0, 5: 0})
    ...
    def test_information_gain_positive(self):
        ...
        r2.beliefs["f1"] = BeliefState(distribution={1: 0, 2: 0.5, 3: 0.5, 4: 0, 5: 0})  # entropy 1.0
    ...
    def test_uncertainty_reduction(self):
        ...
        r2.beliefs["f1"] = BeliefState(distribution={1: 0, 2: 0, 3: 1.0, 4: 0, 5: 0})
    ...
    def test_tom_delta_positive(self):
        ...
        good[0].beliefs["f1"] = BeliefState(distribution={1: 0, 2: 0.1, 3: 0.8, 4: 0.1, 5: 0})
...
class TestMockLLMAgent:
    ...
    def test_mock_agent_produces_orders(self):
        ...
        p2_deploy = {f.id: p for f, p in zip(p2.forces, [1, 2, 3, 4, 5], strict=False)}
...
class TestTelemetryIntegration:
    ...
    def test_mock_agent_game_produces_telemetry(self):
        ...
        telemetry = GameTelemetry(
            ...
            p1_strategy=agent_p1.name,
            p2_strategy=agent_p2.name,
            seed=42,
        )
